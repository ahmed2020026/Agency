...
import work_mobile_app from './work_mobile_app.avif'
import work_fitness_app from './work_fitness_app.avif'
import work_dashboard_management from './work_dashboard_management.avif'
